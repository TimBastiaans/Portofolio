...
git clone https://github.com/TimBastiaans/Portofolio.git
...
- Navigate to `package.json` and enter your domain name instead of `https://developerfolio.js.org/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/portoFolio`, add the same to the homepage section of `package.json`.
